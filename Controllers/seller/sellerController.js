    ...
    if (!seller.verificationStatus) {
      ...
      if (seller.verificationCodeExpiresAt < Date.now()) {
        ...
        const data = {
          ...
          subject: "Verify seller account - ShopPlusPlus",
        };
        ...
        if (seller.verificationCode === code) {
          ...
          const data1 = {
            subject: "Seller Login - ShopPlusPlus",
...
const deleteSellerById = async (req, res) => {
  try {
    ...
    const data = {
      username: seller.fullName,
      subject: "Seller account deleted - ShopPlusPlus",
    };
...
const deleteProductForSeller = async (req, res) => {
  try {
    ...
    const data = {
      ...
      subject: "Product Deleted - ShopPlusPlus",
    };
...
const updateRefundRequestStatus = async (req, res) => {
  try {
    ...
    const data = {
      ...
      subject: "Refund Request Update - ShopPlusPlus",
...
const acceptOrder = async (req, res) => {
  ...
  try {
    ...
    const data = {
      order: updatedOrder,
      subject: "Order Confirmed - ShopPlusPlus",
    };
...
const cancelOrder = async (req, res) => {
  ...
  try {
    ...
    const data = {
      ...
      reason: reason,
      subject: "Order Cancelled - ShopPlusPlus",
    };
