...
const acceptSeller = async (req, res, next) => {
    ...
    try {
        ...
        const data = {
            subject: 'New Seller Account - ShopPlusPlus',
...
const rejectSeller = async (req, res, next) => {
    ...
    try {
        ...
        res.status(200).json({
            ...
            subject: 'New Seller Account Request Rejected - ShopPlusPlus'
        });
        ...
        const data = {
            subject: 'New Seller Account Rejected - ShopPlusPlus',
...
const updateSeller = async (req, res) => {
    ...
    try {
        ...
        const data = {
            ...
            subject: 'Seller Updated - ShopPlusPlus'
        };
...
const banSeller = async (req, res) => {
    ...
    try {
        ...
        const data = {
            ...
            subject: 'Account banned - ShopPlusPlus'
        };
