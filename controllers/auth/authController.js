        ...
        User.findByCredentials(email, password).then(async ({ token, user }) => {
            ...
            if (user.role === "seller") {
                ...
                res.cookie('token', token, {
                    ...
                    sameSite: 'Lax', // cookie should only be sent for same-site requests
...
exports.updateProfile = async (req, res) => {
    ...
    try {
        ...
        const data = {
            ...
            subject: 'Account Updated - ShopPlusPlus'
        };
...
exports.updatePassword = async (req, res) => {
    ...
    try {
        ...
        const data = {
            ...
            subject: 'Password Updated - ShopPlusPlus'
        };
...
exports.deleteAccount = async (req, res) => {
    ...
    try {
        ...
        const data = {
            ...
            subject: 'Account Deleted - ShopPlusPlus'
        };
        res.clearCookie('token');
        res.status(200).json({
            status: 'success',
...
exports.forgotPassword = async (req, res) => {
    try {
        ...
        const data = {
            ...
            subject: 'Reset Password - ShopPlusPlus'
        };
